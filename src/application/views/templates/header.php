...
<head>
    ...
    <!-- Add fancyBox -->
    <link rel="stylesheet" href="<?= base_url('statics/fancybox/source/jquery.fancybox.css?v=2.0.4') ?>" type="text/css"
          media="screen"/>
    <!-- Optionaly add button and/or thumbnail helpers -->
    <link rel="stylesheet" href="<?= base_url('statics/fancybox/source/helpers/jquery.fancybox-thumbs.css?v=2.0.4') ?>"
          type="text/css" media="screen"/>
    <link rel="stylesheet" href="<?= base_url('statics/fancybox/source/helpers/jquery.fancybox-buttons.css?v=2.0.4') ?>"
          type="text/css" media="screen"/>


    <link rel="stylesheet" href="<?= base_url('statics/css/styles.css?v=20251129') ?>"/>
